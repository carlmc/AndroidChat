...
import com.example.cmunayll.androidchat.chat.ChatPresenter;
import com.example.cmunayll.androidchat.chat.ChatPresenterImpl;
import com.example.cmunayll.androidchat.chat.adapters.ChatAdapter;
...
public class ChatActivity extends AppCompatActivity implements ChatView {
    ...
    @BindView(R.id.etMessage) EditText inputMessage;
    ...
    private void setToolbarData(Intent i) {
        ...
        boolean online = i.getBooleanExtra(EMAIL_KEY, false);
        String status = online ? "online" : "offline";
        int color = online ? Color.GREEN : Color.RED;

        tvUser.setText(recipient);
